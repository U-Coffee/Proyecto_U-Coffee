...
var RegistroPage = /** @class */ (function () {
    function RegistroPage(http, alertCtrl, router) {
        this.http = http;
    ...
    RegistroPage.prototype.alert = function (header, subHeader, message) {
    ...
    RegistroPage.prototype.logForm = function () {
        return __awaiter(this, void 0, void 0, function () {
            var datosDB_;
            var _this = this;
            return __generator(this, function (_a) {
                if ((this.ndoc == "")
                    ...
                    this.http.post('https://localhost/u-coffee/validar.php', JSON.stringify(datosDB_)).subscribe(function (res) { return __awaiter(_this, void 0, void 0, function () {
                        var datosDB;
                        var _this = this;
                        return __generator(this, function (_a) {
                            console.log(res);
                            if (res == 1) {
                                ...
                                this.http.post('https://localhost/u-coffee/registro.php', JSON.stringify(datosDB)).subscribe(function (res) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        console.log(res);
                                        if (res == 1) {
