...
export class Tab1Page implements OnInit {
  ...
  logInValidation() {
    ...
    this.http.post('https://u-coffee.000webhostapp.com/index.php', //valida la infomacion con la base de datos
      JSON.stringify(datosDB)).subscribe(async res => {
        console.log(res);
  ...
  loadUser() {
    ...
    this.http.post('https://u-coffee.000webhostapp.com/user.php', JSON.stringify(datosDB)).subscribe(async res => {
      this.datos = res;
      ...
      buttons: [
        {
          ...
          handler: () => {
            ...
            this.http.post(
              'https://u-coffee.000webhostapp.com/factura.php', //se envian los datos al PHP
              JSON.stringify(datosDB)).subscribe(async res => {
                console.log(res);
                if (res == 1) {
