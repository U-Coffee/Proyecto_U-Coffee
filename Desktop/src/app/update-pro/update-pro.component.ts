...
export class UpdateProComponent implements OnInit {
  ...
  update(columna: any, dato: any) {
    ...
    this.http.post('https://u-coffee.000webhostapp.com/php/update_pro.php',JSON.stringify(datosDB)).subscribe(res =>{
      console.log(res)
  ...
  getInfoPro() {
    ...
    this.http.post('https://u-coffee.000webhostapp.com/php/buscar_pro.php', JSON.stringify(datosDB)).subscribe(res => {
      console.log(res);
      this.infoPro = res;
    });
  }
